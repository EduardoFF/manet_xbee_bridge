...
class pose_gps_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(pose_gps_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != pose_gps_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return pose_gps_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if pose_gps_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if pose_gps_t._packed_fingerprint is None:
            pose_gps_t._packed_fingerprint = struct.pack(">Q", pose_gps_t._get_hash_recursive([]))
        return pose_gps_t._packed_fingerprint
